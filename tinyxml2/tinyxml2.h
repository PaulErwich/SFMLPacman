...
public:
    ...
    void Trace( const char* name ) {
        printf( "Mempool %s watermark=%d [%dk] current_state=%d size=%d nAlloc=%d blocks=%d\n",
	...
	// The game_states file is large, 170k.
...
public:
    ...
    */
    ...
    /**
    	...
    	from the current_state Document. (this->GetDocument())
    ...
    */
	...
	/**
		...
		be allocated in the current_state document. If 'target'
	...
	*/
    ...
    /**
    	Test if 2 nodes are the same, but don't game_states children.
...
public:
    ...
    */
    ...
    /**
    	If in print to memory mode, restart the buffer to the
    	beginning.
    */
